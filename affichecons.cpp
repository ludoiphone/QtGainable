...
AfficheCons::AfficheCons()
{
    ...
    m_label1 ->setPixmap(QPixmap("/home/ludo/Qt/test2/build/images/dispCons.jpeg"));
...
// colone temp echangeur int 
    ...
    connect(m_quitter, &QPushButton::clicked, m_quitter, [this](){/*m_window1 ->close();*/ m_timer2 ->stop(); delete m_window1;});
