...
ModifCons::ModifCons()
{
    ...
    m_label2 ->setPixmap(QPixmap("/home/ludo/Qt/test2/build/images/modifCons.jpg"));
...
{
    //m_modifConsignes = new Parametres(QString("settings/parametres.ini"), QSettings::IniFormat);
