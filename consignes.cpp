...
void Consignes::ecritConsigneIntCa()
{
    qDebug() << "ecritConsigneIntCa()";
    
    this ->beginGroup("Consignes");
    this ->setValue("ConsigneInterieurCanicule", consigneIntCa);
    this ->endGroup();
}

void Consignes::ecritConsigneVentIntCa()
{
    qDebug() << "ecritConsigneVentInCa()";
    
    this ->beginGroup("Consignes");
    this ->setValue("ConsigneVentilationInterieurCanicule", consigneVentIntCa);
    this ->endGroup();
}
...
void Consignes::lireConsignesGainable() // lire consignes
{
    ...
    consigneIntCa = this ->value("ConsigneInterieurCanicule").toDouble();
    consigneVentIntCa = this ->value("ConsigneVentilationInterieurCanicule").toDouble();
    this ->endGroup();
}
